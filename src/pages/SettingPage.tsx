        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-3">
          {Object.values(THEMES).map((t) => (
            <button
              key={t}
              className={`
                group flex flex-col items-center gap-2 p-1 transition-transform transform
                ${theme === t ? "bg-base-200 border-1 border-primary scale-105" : "hover:scale-110 hover:bg-base-200/50"}
                rounded-full
              `}
              onClick={() => setTheme(t)}
            >
              {/* Circular Theme Preview */}
              <div
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Amshu Pokharel</h3>
