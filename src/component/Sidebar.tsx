...
// import type { IMessageResponse, IReceiverInfo, IUserInfo } from "../api/message"
...
//   const isReceiverInfo = (user: IUserInfo | IReceiverInfo | null): user is IReceiverInfo => {
...
//             onClick={() => {
//               const clickedUser: IReceiverInfo = {
//                 id: user.users?.other?.id,
//                 fullName: user.users?.other?.fullName,
//                 avatar: user.users?.other?.avatar,
//                 username: user.users?.other?.username,
//                 email: user.users?.other?.email,
//               }
...
//       ${isReceiverInfo(selectedUser) && selectedUser.id === user.users?.other?.id ? "bg-base-300 ring-1 ring-base-300" : ""}
//     `}
//           >
